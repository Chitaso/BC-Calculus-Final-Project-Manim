...
class ProblemStatement(Scene):
    def construct(self):
        ...
        tex = Tex(
            r"`A solid lies between the planes perpendicular to the $x$ axis at $x=0$ and $x=4$. Cross sections perpendicular to the $x$ axis between them are squares whose diagonals run from $y=-\sqrt{x}$ to $y=\sqrt{x}$. Find the formula for the area of the cross section $A(x)$, then find the volume $V$.").scale(0.75)
