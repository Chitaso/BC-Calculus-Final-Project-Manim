...
class ProblemStatement(Scene):
    def construct(self):
        ...
        # tex = Tex(
        #     r"``The Solid'' lies between the planes perpendicular to the x-axis at $x=0$ and $x=4$. Cross sections perpendicular to x-axis between them are squares whose diagonals run from $y=-\sqrt{x}$ to $y=\sqrt{x}$. Find the formula for $A(x)$ of the cross section, then find $V$.").scale(0.75)
        ...
        self.play(Write(tex, run_time=7))
